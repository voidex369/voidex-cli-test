...
const InputArea = ({ input, setInput, onSubmit, suggestions, selectedIndex, hasMemory, isLoading, resetKey = 0, error = null, showExitNotice = false, cwd = '' }) => {
