...
export const Scrollable = ({ children, width, height, maxWidth, maxHeight, hasFocus, scrollToBottom, flexGrow, }) => {
    ...
    return (_jsx(Box, { ref: ref, width: width ?? maxWidth, height: height, flexDirection: "column", overflowY: "hidden", overflowX: "hidden", flexGrow: flexGrow, children: _jsx(Box, { flexShrink: 0, paddingRight: 1, flexDirection: "column", marginTop: -scrollTop, children: children }) }));
};
