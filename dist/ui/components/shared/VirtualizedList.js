...
function VirtualizedList(props, ref) {
    ...
    return (_jsx(Box, { ref: containerRef, overflowY: "hidden", overflowX: "hidden", width: "100%", height: "100%", flexDirection: "column", paddingRight: 1, children: _jsxs(Box, { flexShrink: 0, width: "100%", flexDirection: "column", marginTop: -scrollTop, children: [_jsx(Box, { height: topSpacerHeight, flexShrink: 0 }), renderedItems, _jsx(Box, { height: bottomSpacerHeight, flexShrink: 0 })] }) }));
}
const VirtualizedListWithForwardRef = React.memo(forwardRef(VirtualizedList));
